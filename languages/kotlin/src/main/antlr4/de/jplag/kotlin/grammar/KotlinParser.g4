/**
 * Kotlin (version 1.9.10) Grammar for ANTLR v4
 * Source: https://github.com/Kotlin/kotlin-spec/blob/release/grammar/src/main/antlr/KotlinParser.g4
 *
 * Modifications:
...
tryExpression
    : TRY NL* tryBody ((NL* catchBlock)+ (NL* finallyBlock)? | NL* finallyBlock)
    ;
...
catchBlock
    : CATCH NL* LPAREN annotation* simpleIdentifier COLON type (NL* COMMA)? RPAREN NL* catchBody
    ;
